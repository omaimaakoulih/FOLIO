...
@Component({
  selector: 'app-portfolio2-services',
  templateUrl: './portfolio2-services.component.html',
  styleUrls: ['./portfolio2-services.component.css']
})
export class Portfolio2ServicesComponent {
